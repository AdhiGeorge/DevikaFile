...
class Feature(BaseAgent):
    ...
    def format_prompt(self, feature_request: str, context: str = "") -> str:
        """Format the feature prompt with the feature request and context."""
        prompt_template = self.get_prompt("feature")
        if not prompt_template:
            raise ValueError("Feature prompt not found in prompts.yaml")
        return super().format_prompt(prompt_template, feature_request=feature_request, context=context)
